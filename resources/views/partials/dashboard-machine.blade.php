...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto sm:px-4 lg:px-6 pt-6">
...
<div class="max-w-7xl mx-auto sm:px-4 lg:px-6 pt-6">
    <div class="bg-white shadow-sm sm:rounded-lg">
        <div class="p-4">
            <h3 class="text-lg font-bold mb-2">Daily Production Plan <span class="text-gray-400">(Assigned Item
                    Code)</span></h3>
            @if ($datas->isNotEmpty())
                <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden text-center text-sm">
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                            ...
                            <tr class="bg-white border-b text-center">
                                ...
                                <td class="py-1 px-2">{{ $data->shift }} ({{ $startTime }} - {{ $endTime }})
                                </td>
        ...
        @if ($uniquedata != null)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <table class="min-w-full bg-white border border-gray-200 mt-2 text-sm">
                        <thead>
                            <tr class="bg-gray-100">
                                <th class="py-1 px-2 border-b text-left">SPK Number</th>
                                <th class="py-1 px-2 border-b text-left">Item Code</th>
                                <th class="py-1 px-2 border-b text-left">Scanned Quantity</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <form method="GET" action="{{ route('reset.jobs') }}" class="mt-4">
                        <button type="submit"
