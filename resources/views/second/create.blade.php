<x-app-layout>
    <div class="max-w-3xl mx-auto py-8">
        ...
        <form
            action="{{ route('second.daily.process.store') }}"
            method="POST"
            x-data="planningForm()"
            class="space-y-6"
        >
            ...
            <div class="space-y-4 bg-white p-6 shadow-md rounded-md">
                <div
                    x-data
                    x-init="window.flatpickr($refs.planDate, { dateFormat: 'Y-m-d' })"
                >
                    <label
                        for="plan_date"
            ...
            <!-- Repeatable section -->
            <template
                x-for="(section, index) in repeatableSections"
                :key="index"
            >
                <div class="space-y-4 bg-gray-50 p-6 shadow-md rounded-md">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            "
                            @change="fetchItemDescription($event.target.value, index)"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            x-model="section.itemDescription"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            readonly
                            required
                        />
