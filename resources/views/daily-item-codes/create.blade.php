                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form id="input-form" method="POST" action="{{ route('daily-item-code.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="max-quantity-display" class="max-quantity-display"></div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateShiftInputs() {
                ...
                function processNextShift(currentShift, itemCode) {
                    ...
                    if (nextItemCodeSelector && nextItemCodeSelector.value === itemCode) {
                        const nextQuantity = nextQuantityInput ? nextQuantityInput.value : null;
                        if (nextQuantity) {
                            // Continue calculation for the next shift
                ...
                document.querySelectorAll('.quantity-input').forEach(input => {
                    input.addEventListener('input', function() {
                        ...
                        console.log('quantity changes:' + input.value);
                        // Trigger AJAX when both item_code and quantity are provided
                        triggerAjax(shift, itemCode, quantity);
                    });
                });
